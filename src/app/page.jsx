...
export default function Home() {
  ...
  //   // Check for additional data based on permissions
  //   if (WebApp.initDataUnsafe?.permissions?.includes("contacts")) {
  //     // Access contacts data if permission granted
  ...
  // mainpage database references
  const coinRef = child(userRef, "coins");
  const usernameRef = child(userRef, "username");
        ...
        <div className="bg-gradient-to-b from-gray-900 to-black flex justify-center">
          <div className="w-full text-white h-screen font-bold flex flex-col max-w-md relative">
            {settingsOpen ? (
              ...
              <>
                <Leaderboard setView={toggleLeaderboard} usersRef={usersRef} />
              </>
            ) : (
              <>
                  ...
                  <div className="flex items-center mt-4">
                    <div className="flex flex-col items-start w-full">
                      <div className="flex justify-between w-full">
                        ...
                        <p className="text-sm">{`${currentEnergy}/${totalEnergy}`}</p>
                      </div>
                      <div className="w-full h-4 bg-gray-700 rounded-full mt-1 relative">
                        <div
                        ...
                        ></div>
                        <div
                          className="absolute top-0 transform -translate-x-1/2 h-4 w-4 rounded-full bg-green-500 shadow-lg glow-pulse"
                          style={{
                    ...
                    >
                      <div className="relative w-full h-full">
                        ...
                        {showAnimation && (
                          ...
                          >
                            +1 <GiTwoCoins className="inline text-yellow-400" />
                          </div>
                        )}
                      </div>
